...
[📂 View Phase 1 Work →](./phase-1-service/)
...
[📂 View Phase 2 Work →](./phase-2-deployments/)
...
[📂 View Phase 3 Work →](./phase-3-platform-components/)
...
[📂 View Phase 4 Work →](./phase-4-portfolio/)
...
[View all learnings →](./learning-log/things-ive-learned.md)
...
[View all incidents →](./phase-1-service/incidents/)
...
[View all decisions →](./phase-1-service/docs/decisions/)
...
[View question history →](./learning-log/weekly-reviews/)
...
```
platform-engineering-portfolio/
├── phase-1-service/           # Weeks 1-4: Service foundations
│   ├── src/                   # Application code
│   ├── docs/                  # Architecture & design docs
│   ├── incidents/             # Failure reports
│   └── tests/                 # Test suites
├── phase-2-deployments/       # Weeks 5-8: Production ops
│   ├── terraform/             # Infrastructure as code
│   ├── runbooks/              # Operational procedures
│   └── chaos-experiments/     # Failure injection tests
├── phase-3-platform-components/  # Weeks 9-12: Platform work
│   ├── deployment-template/   # Reusable deploy configs
│   ├── observability-bootstrap/  # Observability library
│   └── auth-middleware/       # Authentication component
├── phase-4-portfolio/         # Weeks 13-16: Communication
│   └── technical-writing/     # Polished documentation
└── learning-log/              # Meta-learning
    ├── weekly-reviews/        # Weekly reflections
    ├── phase-retrospectives/  # Phase summaries
    └── things-ive-learned.md  # Continuous learnings
```
...
- **Blog**: [Medium](https://medium.com/@jimmymaina) | [Hashnode](https://jimmymaina.hashnode.dev/) | [Dev.to](https://dev.to/jimmy-maina)
